...
namespace FishingEvents.Infrastructure.Migrations
{
    ...
    [Migration("20241028171524_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FishingEvents.Infrastructure.Data.Models.Organiser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FishingEvents.Infrastructure.Data.Models.FishingEvent", b =>
                {
                    ...
                    b.HasOne("FishingEvents.Infrastructure.Data.Models.Organiser", "Organiser")
            ...
            modelBuilder.Entity("FishingEvents.Infrastructure.Data.Models.Organiser", b =>
                {
                    b.HasOne("FishingEvents.Infrastructure.Data.Models.ApplicationUser", "User")
                        .WithOne("Organiser")
                        .HasForeignKey("FishingEvents.Infrastructure.Data.Models.Organiser", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("FishingEvents.Infrastructure.Data.Models.Participant", b =>
                {
                    b.HasOne("FishingEvents.Infrastructure.Data.Models.ApplicationUser", "User")
                        .WithOne("Participant")
                        .HasForeignKey("FishingEvents.Infrastructure.Data.Models.Participant", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
