        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Elevation = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false),
                    FishingType = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HabitatName = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    FishBait = table.Column<string>(type: "nvarchar(60)", maxLength: 60, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrganizerId = table.Column<string>(type: "nvarchar(450)", nullable: false, comment: "Foreign key for the organizer of the event"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false, comment: "FishCaught identifier")
                        .Annotation("SqlServer:Identity", "1, 1"),
                    FishingEventId = table.Column<int>(type: "int", nullable: false),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    ...
                    CaughtImageUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalFishCaught = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_LeaderBoards", x => new { x.FishingEventId, x.UserId });
                    table.ForeignKey(
